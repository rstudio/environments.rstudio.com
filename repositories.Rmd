...
Ever wondered where R packages come from? The majority of R users install
packages from CRAN. CRAN, the Comprehenisve R Archive Network, is a
network of servers that distribute R along with R packages.

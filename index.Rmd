...
is the foundation of all science. Reproducing work is also critical for buisness
...
2. The [Shared Baseline](./shared.html) strategy helps administrators co-ordinate the work of many data scientists, by providing common sets of packages to use across projects. The key to this strategy is determining a consistent set of packages that work together.

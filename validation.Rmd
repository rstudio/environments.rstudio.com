...
[here](https://r-pkgs.had.co.nz/tests.html#test-cran).
...
-[Books](https://www.cookbook-r.com/Graphs/)  
...
- Package dependencies can be viewed in the package's Description file and come in a [few flavors](https://r-pkgs.had.co.nz/description.html#dependencies): Suggests, Depends, Imports, and LinkingTo.  

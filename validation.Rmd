...
title: "Validation"
description: |
  Using R for Validated Work [In Progress]
---

Validating a environmnent consists of 2 elements:
...
packages are accurate in their stated purpose. Unfortunately, with `r
nrow(available.packages(repo="https://cran.rstudio.com"))`^[Run on `r
Sys.Date()`] R packages on CRAN, and more added each day, it is impossible to
...
- [RStudio IDE Validation](https://www.rstudio.com/wp-content/uploads/2014/06/RStudio-Commercial-IDE-Validation.pdf)  
